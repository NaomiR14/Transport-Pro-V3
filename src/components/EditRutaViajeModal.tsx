...
export default function EditRutaViajeModal({ ruta, onSave, onClose, isOpen }: EditRutaViajeModalProps) {
    ...
    // Cargar datos de vehículos y conductores (en un caso real vendrían de APIs)
    useEffect(() => {
    ...
    const volumenCombustible = formData.total_combustible && formData.precio_por_galon ? formData.total_combustible / formData.precio_por_galon : 0
