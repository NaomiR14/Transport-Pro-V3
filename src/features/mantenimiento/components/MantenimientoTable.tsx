      ...
      <Table>
        <TableHeader className="bg-gradient-to-r from-slate-50 to-slate-100/50 dark:from-slate-800/80 dark:to-slate-800/50">
          <TableRow className="hover:bg-transparent border-b border-slate-200 dark:border-slate-700">
            ...
            <TableHead className="font-bold uppercase text-xs tracking-wider text-slate-600 dark:text-slate-400">Descripción</TableHead>
            <TableHead className="font-bold uppercase text-xs tracking-wider text-slate-600 dark:text-slate-400">Taller</TableHead>
            ...
            <TableHead className="font-bold uppercase text-xs tracking-wider text-slate-600 dark:text-slate-400">Costo</TableHead>
